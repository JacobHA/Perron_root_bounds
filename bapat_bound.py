...
def first_iter(A, B):
    ...
    # return np.exp(-thetaB_bound + correction) # this was a conjecture for an upper bound
...
def test_tightness():
    ...
    print(
        f"Average error of first iteration bound: {np.mean(first_iter_errors)}")
